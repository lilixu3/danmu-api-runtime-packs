...
import { arrayCompatNormalize, arrayCompatNormalizeInput, castToText, castToTextArr, makeBoxArray, makeGeometryArray, parseGeometryArrayAndNormalize, parseGeometryTuple, parseGeometryXY, parseLineABC, parseLineTuple, parsePgArrayAndNormalize, parsePgVector, parsePointTuple, parsePointXY, refineGenericPgCodecs } from "../../pg-core/codecs.js";
...
const bunSqlPgCodecs = refineGenericPgCodecs({
	...
	bigint: { normalizeParamArray: (v) => makePgArray(v) },
	"bigint:number": {
		normalize: Number,
		normalizeArray: arrayCompatNormalize(Number),
		normalizeParamArray: (v) => makePgArray(v)
